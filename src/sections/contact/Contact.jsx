    ...
    return (
        <>
            <Flex alignItems="center" w={["90%", "86%", "75%", "58%"]} justifyContent="center" height={["100vh", "100vh", "68vh", "100%"]}
                position="absolute" flexDir="column" display="column" top={["368rem", "354rem", "276rem", "300rem"]} id="contact">
                ...
                <Flex  >
                    <Flex alignItems="center" w="100%" justifyContent="center" gap="12rem" >
                        {/* <Flex display="grid" gridTemplateColumns="30% 58%" gap="12%"> */}
                        <Flex align="center" gap="1.2rem" flexDir="column">
                            {contactMethods.map((data) =>
                                <Flex key={data.id} w="17rem" alignItems="center" backgroundColor={colors.backgroundVariant} padding="1.2rem" borderRadius="1.2rem" textAlign="center" border="1px solid transparent" transition="all 400ms ease" _hover={{ backgroundColor: "transparent", border: `1px solid ${colors.primaryVariant}` }} flexDir="column" id={data.id}>
